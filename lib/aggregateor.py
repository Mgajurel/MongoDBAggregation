...
def alligator():
    ...
    """
    pipeline1 = {'$match': {'items.name': {
        '$in': ['bagpack', 'laptop']}, 'purchaseMethod': 'Online', 'customer.age': {'$lt': 30}}}
    ...
    pipeline4 = {'$addFields': {'customer': '$_id'}}

    pipeline5 = {'$project': {'totalPurchase': 1, 'customer': 1, '_id': 0, 'environment':
                              {'$switch': {'branches': [
                                  {'case': {
